...
{
    name: "pipedrive_request",
    description:
      "Execute an API request against Pipedrive. Pipedrive sales CRM (deals, persons, organizations, activities). " +
      "Provide the HTTP method, path, and optional params/body.",
    parameters: Type.Object({
      agent_id: Type.String({ description: "Agent with Pipedrive integration" }),
    ...
    async execute(_id: string, p: any) {
      return json(await post("/integrations/pipedrive/request", p));
    },
  }
];

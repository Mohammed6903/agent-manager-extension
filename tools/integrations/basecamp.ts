...
const INTEGRATION_NAME = "basecamp";

const INTEGRATION_TOOLS: any[] = [
{
    name: "basecamp_request",
    description:
      "Execute an API request against Basecamp. Basecamp project management (projects, to-do lists, to-dos, people). " +
      "Provide the HTTP method, path, and optional params/body.",
    parameters: Type.Object({
      agent_id: Type.String({ description: "Agent with Basecamp integration" }),
    ...
    async execute(_id: string, p: any) {
      return json(await post("/integrations/basecamp/request", p));
    },
  }
];
